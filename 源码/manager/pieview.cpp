...
void PieView::paintEvent(QPaintEvent *)
{
    ...
    int y0=280;
    //y坐标轴
    painter.drawLine(x0,y0,40,60);
    painter.drawLine(38,62,40,60);
    painter.drawLine(40,60,42,62);
    painter.drawText(20,53,tr("销售数量"));
    for(int i=1;i<5;i++)
    {
    ...
    //x 坐标轴
    painter.drawLine(x0,y0,390,280);
    painter.drawLine(388,278,390,280);
    painter.drawLine(390,280,388,282);
    painter.drawText(405,280,tr("品牌"));
